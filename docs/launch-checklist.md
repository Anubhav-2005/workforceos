...
- [ ] Begin on the dashboard and state the coordination problem.
- [ ] Demonstrate Recruiter upload → structured analysis → human decision.
- [ ] Demonstrate the Workforce Engine approval pause and cross-role handoff.
- [ ] Show analytics and mobile responsiveness.
- [ ] Be transparent that workflows are simulated for the MVP and explain the production path.
